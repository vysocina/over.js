...
(function(window){
	...
	function OverJS(target, setup) {
		...
		//settung contextMenuPreventDefault
		if(setup.contextMenuPreventDefault != undefined) {
			setup.contextMenuPreventDefault = setup.contextMenuPreventDefault;
		} else if(setup.rightClickPreventDefault != undefined) {
			setup.contextMenuPreventDefault = setup.rightClickPreventDefault;
		} else {
			setup.contextMenuPreventDefault = true;
		}
		...
		this.setup = {
			...
			contextMenuPreventDefault: setup.contextMenuPreventDefault,
